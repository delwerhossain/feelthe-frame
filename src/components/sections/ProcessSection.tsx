...
const processSteps = [
  {
    ...
    description:
      "We start with understanding your goals, audience, and vision. Our team develops concepts, creates scripts, and plans every detail.",
    features: [
  ...
  },
  {
    ...
    title: "Production",
    description:
      "Our experienced crew brings your vision to life with professional equipment and creative expertise.",
    features: [
  ...
  },
  {
    ...
    description:
      "Expert editing, color correction, sound design, and final touches that make your video shine.",
    features: [
...
export default function ProcessSection() {
  return (
    <section
      id="process"
      className="py-24 bg-gradient-to-b from-gray-50/5 to-white/5 rounded-t-[32px]"
    >
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="relative">
          ...
          {processSteps.map((process, index) => (
            <div
              key={index}
              className={`relative mb-16 last:mb-0 ${process.side === "right" ? "flex-row-reverse" : ""} flex items-center gap-8`}
            >
              {/* Step Marker */}
              ...
              {/* Content */}
              <div
                className={`flex-1 ${process.side === "right" ? "text-right pl-16" : "pr-16"}`}
              >
                <div
                  className={`bg-midnight-light rounded-[20px] p-6 border border-white/8 ${process.side === "right" ? "ml-auto" : ""} max-w-md`}
                >
                  ...
                  <div className="space-y-2">
                    {process.features.map((feature, idx) => (
                      <div
                        key={idx}
                        className={`flex items-center gap-2 text-sm text-white/60 ${process.side === "right" ? "justify-end" : ""}`}
                      >
              ...
              {/* Image */}
              <div
                className={`flex-1 ${process.side === "right" ? "pr-16" : "pl-16"}`}
              >
