...
const services = [
  {
    title: "Video Editing",
    description:
      "Professional post-production services that bring your vision to life with expert editing, color correction, and sound design.",
  ...
  },
  {
    title: "Filming",
    description:
      "Complete filming services with professional equipment and experienced crew to capture your story perfectly.",
  ...
  },
  {
    ...
    description:
      "End-to-end video production from concept development to final delivery, handling every aspect of your project.",
  ...
  },
  {
    title: "Social Media",
    description:
      "Optimized video content for social platforms that engages audiences and drives conversions.",
    image: "/assets/images/editing-image.jpg",
    features: [
  ...
  },
  {
    title: "UGC",
    description:
      "User-generated content strategies that build authentic connections with your audience.",
    image: "/assets/images/filming-image.jpg",
    features: [
      "Content Strategy",
  ...
  },
  {
    title: "Live Events",
    description:
      "Professional live event coverage and streaming services for conferences, launches, and special occasions.",
    image: "/assets/images/full-production-image.jpg",
    features: [
      "Live Streaming",
      "Event Documentation",
...
export default function ServicesSection() {
  return (
    <section
      id="services"
      className="py-24 bg-gradient-to-b from-midnight to-midnight-light rounded-t-[32px] relative"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-white/72 text-lg max-w-2xl mx-auto">
            Comprehensive video production services tailored to your business
